...
export const videos: Video[] = [
  {
    ...
    description: 'Learn the most common greetings and expressions used in traveling via airport.',
    thumbnailUrl: 'https://i3.ytimg.com/vi/DlL1KwykyWY/maxresdefault.jpg',
    videoUrl: 'https://www.youtube.com/watch?v=DlL1KwykyWY',
    level: 'beginner',
    duration: '8:24',
